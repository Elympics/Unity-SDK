...
* add check for user mm cancellation ([597dd91](https://github.com/Elympics/Unity-SDK/commit/597dd911fc3d3e8106b1b89a9149f5ccbffd5f69))
* call state.disconnect on disconnection. ([aacd4f7](https://github.com/Elympics/Unity-SDK/commit/aacd4f7f8cde0c518d8496521573d97164063e2a))
* cleaning activity token ([0b69587](https://github.com/Elympics/Unity-SDK/commit/0b695875ca811facdf7bac3625c060fb60f0d2bf))
* Clear the list of rooms after tracking is disabled ([88ca228](https://github.com/Elympics/Unity-SDK/commit/88ca228938728f23235649ff5fcf38e5af23d593))
...
* dispose current room after leaving plus tests ([5417301](https://github.com/Elympics/Unity-SDK/commit/5417301f82c198fd03177f4e82677d8df0108028))
...
* Don't throw exception when calling StopTrackingAvailableRooms if the tracking is not enabled ([cfef127](https://github.com/Elympics/Unity-SDK/commit/cfef1271f4c0b069e8402717562a6b530492a00d))
* don't update public room when user is member ([4c2807a](https://github.com/Elympics/Unity-SDK/commit/4c2807a2d1d6b40335448d6c89f90d7e8e2256f3))
* dont disconnect if we requeted cancelling ([67377cc](https://github.com/Elympics/Unity-SDK/commit/67377cc72d4afc7acc0dc7728e25679496af9e42))
* Dont pass cancelled token ([0dfefd0](https://github.com/Elympics/Unity-SDK/commit/0dfefd089215b3bc5462a225439e74db7dde31bc))
* elympics client state returning to Connected ([d7e73d1](https://github.com/Elympics/Unity-SDK/commit/d7e73d1631a37b6cbe01622f6867b32f26b18a89))
* ElympicsLobbyCLient switch to mm state ([2b45b20](https://github.com/Elympics/Unity-SDK/commit/2b45b208f36686d58d7e10827f9ff7c84f02a2a4))
* error message for room destroyed when joining ([e16a832](https://github.com/Elympics/Unity-SDK/commit/e16a832ed1387d6b5856cede5f6944d848eda27f))
* exit start matchmaking after instant failure. ([f0f7570](https://github.com/Elympics/Unity-SDK/commit/f0f7570ba2ad86e6f08131c0d1dfb8c7f778a090))
* Fix match trying to be cancelled while its state becomes Matched ([a05678c](https://github.com/Elympics/Unity-SDK/commit/a05678c03adbd0444233987112454350a64254d4))
* force disconnection ([5bc8bf9](https://github.com/Elympics/Unity-SDK/commit/5bc8bf9a85af491ab1f1e042777760ddea4b715c))
...
* ienumerable comparision ([c15fd35](https://github.com/Elympics/Unity-SDK/commit/c15fd35847acfddffb680176a5fc4ea5860872c0))
* logging null byte array ([84f7da1](https://github.com/Elympics/Unity-SDK/commit/84f7da1f44b78c68bf57514c601fd5b8879824a4))
* Make Leave, StartMatchmaking and CancelMatchmaking wait for the room state to be updated accordingly ([0db5ff8](https://github.com/Elympics/Unity-SDK/commit/0db5ff835deb1d78df813470e767cf901b3f7365))
* message pack formatting ([bf41e70](https://github.com/Elympics/Unity-SDK/commit/bf41e70823515315ea5e4655be0734a2fc43c75d))
* missing public event ([eebbf85](https://github.com/Elympics/Unity-SDK/commit/eebbf85b5e0ccccbb9440794302707139c1fc1ef))
* no cancellation on joined room ([adf05e0](https://github.com/Elympics/Unity-SDK/commit/adf05e06047ad04191ca5e5087cb6759e27d9709))
* null ref ([46f2c7b](https://github.com/Elympics/Unity-SDK/commit/46f2c7bd2757e111689736482e848b33cd8c4378))
* null reference ([12c3c18](https://github.com/Elympics/Unity-SDK/commit/12c3c18f619504a7cf77d9bc867b751c1a9fed30))
* Prevent debug room state info being output every time assemblies are reloaded ([a31ea06](https://github.com/Elympics/Unity-SDK/commit/a31ea0675a204759738f26d548c4e84106177021))
* Prevent race condition from occurring when weaving Elympics.dll ([ac44bfc](https://github.com/Elympics/Unity-SDK/commit/ac44bfc59f0646cca0a2cb3579230a715cfa14bd))
...
* providing available regions for given game ([e037d1d](https://github.com/Elympics/Unity-SDK/commit/e037d1d53ccb2f2ff2ec9988b6774862fea10986))
* reconnect Elympics when Lobby scales down ([87611a5](https://github.com/Elympics/Unity-SDK/commit/87611a5f6e3beffd6e3fbaccd3990a22554b525c))
* Refactor rooms classes to allow only one room to be active at once ([5dc1c6a](https://github.com/Elympics/Unity-SDK/commit/5dc1c6a655bb796821597936ae54172de7e11994))
...
* reset joiner on exception ([77610ac](https://github.com/Elympics/Unity-SDK/commit/77610acdac72f44f9ae64eb094a2c8283fbbde02))
* reset matchdata when starting mm ([9081652](https://github.com/Elympics/Unity-SDK/commit/9081652a5fcc341221d24ebc39de7e9e5af7c97b))
* reset room tracker on disconnection ([bf1d50d](https://github.com/Elympics/Unity-SDK/commit/bf1d50d0eee7b33ffb6209827139f55466c39232))
* reseting timer ([c815a0e](https://github.com/Elympics/Unity-SDK/commit/c815a0e3e7ce7462eb9f19ebafdf26d79d013044))
* skip mm cancel if already requested ([fea663c](https://github.com/Elympics/Unity-SDK/commit/fea663cb7243bb9a4c807f7bbb8532f63e7eedbe))
* updateRoomParams betAmount sender ([405bc61](https://github.com/Elympics/Unity-SDK/commit/405bc618804ad2d37a762d94bb80a5a6e2e42dcc))
* use UniTask.Delay with DelayType overload ([20e414d](https://github.com/Elympics/Unity-SDK/commit/20e414de1d89997f408caff96fecf2a6194b9f37))
* websocket disconnect public flow ([6b504b7](https://github.com/Elympics/Unity-SDK/commit/6b504b793a1d03afd1637e9be4adfbe412ae7e5b))
...
* check game version when loading a replay ([7395415](https://github.com/Elympics/Unity-SDK/commit/7395415cbcf647da0f5debbeaada5d295be0b36a))
