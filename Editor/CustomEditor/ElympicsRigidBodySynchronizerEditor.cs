...
namespace Elympics
{
    ...
    public class ElympicsRigidBodySynchronizerEditor : UnityEditor.Editor
    {
        ...
        private const string RedundantTransformSynchronizerWarning = "<color=yellow>Warning! Behaviour contains RigidBody Synchronizer. Additional Transform synchronizer may cause performance and synchronization issues.</color> <a href=\"https://docs.elympics.cc/guide/state/#elympicsrigidbodysynchronizer\">Link</a>";
