...
namespace Elympics
{
    ...
    public class ElympicsTransformSynchronizerEditor : UnityEditor.Editor
    {
        ...
        private const string RedundantRigidBodySychronizerWarning = "<color=yellow>Warning! Behaviour contains Transform Synchronizer. Additional RigidBody synchronizer may cause performance and synchronization issues.</color> <a href=\"https://docs.elympics.cc/guide/state/#elympicsrigidbodysynchronizer\"></a>";
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_target.TryGetComponent<ElympicsRigidBodySynchronizer>(out _) || _target.TryGetComponent<ElympicsRigidBody2DSynchronizer>(out _))
            {
                ...
                EditorGUILayout.LabelField(RedundantRigidBodySychronizerWarning, _warningStyle);
