...
namespace Elympics
{
    ...
    {
        [SerializeField, HideInInspector] private List<string> disabledParameters = new();
        [SerializeField, HideInInspector] private List<string> disabledLayers = new();
        ...
        private readonly List<int> _triggerCache = new();
        ...
        private List<ParameterSynchronizationStatus> GetStatusesForType(AnimatorControllerParameterType type)
        {
            return type switch
            {
                AnimatorControllerParameterType.Bool => _boolStatuses,
                AnimatorControllerParameterType.Int => _intStatuses,
                AnimatorControllerParameterType.Float => _floatStatuses,
                AnimatorControllerParameterType.Trigger => _triggerStatuses,
                _ => null,
            };
        }
    }
