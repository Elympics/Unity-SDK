...
namespace Elympics
{
	...
	public class ElympicsRigidBody2DSynchronizerEditor : Editor
	{
		...
		private string Label_TransformAsReduntandSynchronizerWarning = "<color=yellow>Warning! Behaviour contains RigidBody Synchronizer. Additional Transform synchronizer may cause performance and synchronization issues.</color> <a href=\"https://docs.elympics.cc/guide/state/#elympicsrigidbodysynchronizer\"></a>";
