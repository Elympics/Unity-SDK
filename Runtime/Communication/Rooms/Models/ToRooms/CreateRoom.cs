...
namespace Elympics.Rooms.Models
{
    ...
    public record CreateRoom(
        ...
        [property: Key(10)] Guid? RollingTournamentTypeId) : LobbyOperation
    {
        ...
        public CreateRoom(
            ...
            Guid? rollingTournamentTypeId) : this(roomName, isPrivate, isEphemeral, queueName, isSingleTeam, customRoomData, customMatchmakingData, tournamentDetails, betDetailsSlim, rollingTournamentTypeId) =>
