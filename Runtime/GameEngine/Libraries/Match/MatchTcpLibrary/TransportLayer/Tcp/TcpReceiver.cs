...
namespace MatchTcpLibrary.TransportLayer.Tcp
{
    public class TcpReceiver
    {
        ...
        public async UniTaskVoid StartReceiving()
        {
            ...
            int readBytes;
            while (ReadingNotFinished(readBytes = await netStream.ReadAsync(buffer, 0, buffer.Length, _cts.Token).AsUniTask()))
        ...
        private static bool ReadingNotFinished(int readBytes) => readBytes > 0;
    }
}
