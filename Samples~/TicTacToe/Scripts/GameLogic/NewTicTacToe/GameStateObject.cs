...
namespace GameLogic.NewTicTacToe
{
    public class GameStateObject : ElympicsMonoBehaviour
    {
        ...
        [SerializeField] private ElympicsInt player1Side = new();
        [SerializeField] private ElympicsInt player2Side = new();
        [SerializeField] private ElympicsInt currentPlayerTurn = new((int)ElympicsPlayer.Invalid);
        [SerializeField] private ElympicsBool gameOver = new();
