...
namespace Elympics.Tests.RpcMocks
{
    public class RpcHolderWithMetadata : ElympicsMonoBehaviour
    {
        ...
        [ElympicsRpc(ElympicsRpcDirection.ServerToPlayers)]
        public void StpWithOptionalMetadataUsingNew(RpcMetadata metadata = default) => StpWithOptionalMetadataArgs = new ValueTuple<RpcMetadata>(metadata);
        ...
        [ElympicsRpc(ElympicsRpcDirection.PlayerToServer)]
        public void PtsWithOptionalMetadataUsingNew(RpcMetadata metadata = default) => PtsWithOptionalMetadataArgs = new ValueTuple<RpcMetadata>(metadata);
